...
public class TestDeadlineAndPriority {
	...
	public void testValidInput() {
		...
		Assertions.assertTrue(DeadlineAndPriority.sortTask(list));
	...
	public void testInvalidNullArrayList() {
		...
		try {
			DeadlineAndPriority.sortTask(null);
	...
	public void testInvalidEmptyArrayList() {
		...
		try {
			DeadlineAndPriority.sortTask(list);
